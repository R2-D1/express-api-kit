...
exports.createInvite = async (request, response) => {
    ...
    try {
        await sendEmail(email, 'Registration', "Hi there!", `You were invited to ${process.env.APP_NAME} application. Follow link below to continue.`, "Registration", `${process.env.APP_URL}/registration/` + token);
